...
@pytest.mark.parametrize("user", [User(id=12, name='michalile', password='123456')])
@pytest.mark.asyncio
@pytest.mark.order(2)
...
async def test_sign_up():
    ...
    """
    new_user = User(id=12, name='michalile', password='123456')
...
async def test_get_user_by_id():
    ...
    """
    user = User(id=12, name='michalile', password='123456')
    result = await user_service.get_user_by_id(12)
    assert result == user